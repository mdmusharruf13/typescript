...
var _this = this;
var updatedAssignment = function (assign, propsToUpdate) {
...
console.log(assign1);
var assignGraded = updatedAssignment(assign1, { grade: 95 });
...
var tAssign = createNewAssign("Utility Types", 100);
console.log(tAssign);
var assignArgs = ["generics", 100];
var tAssign2 = createNewAssign.apply(void 0, assignArgs);
